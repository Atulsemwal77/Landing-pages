...
const freelancerblogSchema = new mongoose.Schema(
  {
    title: { type: String },
    date: { type: Date },
    author: { type: String },
...
freelancerblogSchema.pre("findOneAndDelete", async function (next) {
  try {
...
module.exports = mongoose.model("Freelancer-Blog", freelancerblogSchema);
